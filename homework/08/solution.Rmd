...
Consider a population of size $N$, then under the current settings we have $x_A N$ individuals of type $A$ and $(1 - x_A)N$ individuals of type $B$.
...
Let $x := (x_A,x_B)$. We reenote the fitness of type $A$ as $F_A$

$$
\begin{aligned}
\dot{x}_A &= x_A[F_A - \phi]
\end{aligned}
$$
...
> Suppose $A$ and $B$ represent two strategies in the classic Hawk-Dove ganme, with the follwoing payoff matrix:
